...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financemanager_portfolioreturn', (
            ('return_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['financemanager.Return'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('financemanager', ['PortfolioReturn'])

        # Adding model 'InvestmentReturn'
        db.create_table('financemanager_investmentreturn', (
            ('return_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['financemanager.Return'], unique=True, primary_key=True)),
            ('investment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financemanager.Investment'])),
        ))
        db.send_create_signal('financemanager', ['InvestmentReturn'])


    def backwards(self, orm):
        
        # Deleting model 'PortfolioReturn'
        db.delete_table('financemanager_portfolioreturn')

        # Deleting model 'InvestmentReturn'
        db.delete_table('financemanager_investmentreturn')
    ...
    models = {
        ...
        'financemanager.investmentreturn': {
            'Meta': {'object_name': 'InvestmentReturn', '_ormbases': ['financemanager.Return']},
            'investment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financemanager.Investment']"}),
            'return_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['financemanager.Return']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'financemanager.portfolioprice': {
            'Meta': {'object_name': 'PortfolioPrice', '_ormbases': ['financemanager.Price']},
        ...
        'financemanager.portfolioreturn': {
            'Meta': {'object_name': 'PortfolioReturn', '_ormbases': ['financemanager.Return']},
        ...
        'financemanager.savingsaccountprice': {
            'Meta': {'object_name': 'SavingsAccountPrice', '_ormbases': ['financemanager.Price']},
            'dividend': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '10'}),
            'investment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financemanager.Investment']"}),
            'price_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['financemanager.Price']", 'unique': 'True', 'primary_key': 'True'})
        },
