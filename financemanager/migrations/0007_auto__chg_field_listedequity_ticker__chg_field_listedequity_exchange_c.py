...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('financemanager_listedequity', 'ticker', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'ListedEquity.exchange_code'
        db.alter_column('financemanager_listedequity', 'exchange_code', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'ListedEquity.ticker'
        db.alter_column('financemanager_listedequity', 'ticker', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'ListedEquity.exchange_code'
        db.alter_column('financemanager_listedequity', 'exchange_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=4))
