...
def chart_technical_analysis(r,ticker,startdate,enddate):
...
def sub_chart_rsi(ax,r,ticker):
	...
	ax.plot(r.date, rsi, color=fillcolor)
	ax.axhline(70, color=fillcolor)
	ax.axhline(30, color=fillcolor)
	ax.fill_between(r.date, rsi, 70, where=(rsi>=70), facecolor=fillcolor, edgecolor=fillcolor)
	ax.fill_between(r.date, rsi, 30, where=(rsi<=30), facecolor=fillcolor, edgecolor=fillcolor)
