...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeDataFile.bulkfile'
        db.add_column('openportfolioapp_tradedatafile', 'bulkfile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'TradeDataFile.investment'
        db.alter_column('openportfolioapp_tradedatafile', 'investment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openportfolioapp.Investment'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'TradeDataFile.bulkfile'
        db.delete_column('openportfolioapp_tradedatafile', 'bulkfile')

        # Changing field 'TradeDataFile.investment'
        db.alter_column('openportfolioapp_tradedatafile', 'investment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['openportfolioapp.Investment']))
