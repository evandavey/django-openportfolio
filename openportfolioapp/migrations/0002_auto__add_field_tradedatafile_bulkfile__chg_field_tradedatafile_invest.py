...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('financemanager_tradedatafile', 'bulkfile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'TradeDataFile.investment'
        db.alter_column('financemanager_tradedatafile', 'investment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financemanager.Investment'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'TradeDataFile.bulkfile'
        db.delete_column('financemanager_tradedatafile', 'bulkfile')

        # Changing field 'TradeDataFile.investment'
        db.alter_column('financemanager_tradedatafile', 'investment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['financemanager.Investment']))
