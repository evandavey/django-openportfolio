...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ListedEquityPrice.price_ptr'
        db.delete_column('openportfolioapp_listedequityprice', 'price_ptr_id')

        # Deleting field 'ListedEquityPrice.investment'
        db.delete_column('openportfolioapp_listedequityprice', 'investment_id')

        # Adding field 'ListedEquityPrice.investmentprice_ptr'
        db.add_column('openportfolioapp_listedequityprice', 'investmentprice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['openportfolioapp.InvestmentPrice'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'SavingsAccountPrice.investment'
        db.delete_column('openportfolioapp_savingsaccountprice', 'investment_id')

        # Deleting field 'SavingsAccountPrice.price_ptr'
        db.delete_column('openportfolioapp_savingsaccountprice', 'price_ptr_id')

        # Adding field 'SavingsAccountPrice.investmentprice_ptr'
        db.add_column('openportfolioapp_savingsaccountprice', 'investmentprice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['openportfolioapp.InvestmentPrice'], unique=True, primary_key=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ListedEquityPrice.price_ptr'
        raise RuntimeError("Cannot reverse this migration. 'ListedEquityPrice.price_ptr' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ListedEquityPrice.investment'
        raise RuntimeError("Cannot reverse this migration. 'ListedEquityPrice.investment' and its values cannot be restored.")

        # Deleting field 'ListedEquityPrice.investmentprice_ptr'
        db.delete_column('openportfolioapp_listedequityprice', 'investmentprice_ptr_id')

        # User chose to not deal with backwards NULL issues for 'SavingsAccountPrice.investment'
        raise RuntimeError("Cannot reverse this migration. 'SavingsAccountPrice.investment' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SavingsAccountPrice.price_ptr'
        raise RuntimeError("Cannot reverse this migration. 'SavingsAccountPrice.price_ptr' and its values cannot be restored.")

        # Deleting field 'SavingsAccountPrice.investmentprice_ptr'
        db.delete_column('openportfolioapp_savingsaccountprice', 'investmentprice_ptr_id')
    ...
    models = {
        ...
        'openportfolioapp.investmentreturn': {
            'Meta': {'object_name': 'InvestmentReturn', '_ormbases': ['openportfolioapp.Return']},
            'investment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['openportfolioapp.Investment']"}),
            'return_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['openportfolioapp.Return']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'openportfolioapp.portfolioreturn': {
            'Meta': {'object_name': 'PortfolioReturn', '_ormbases': ['openportfolioapp.Return']},
            'bm_dividend': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'bm_prev_price': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'bm_price': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'portfolio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['openportfolioapp.Portfolio']"}),
            'return_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['openportfolioapp.Return']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'openportfolioapp.return': {
            'Meta': {'object_name': 'Return'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'dividend': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'freq': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prev_price': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'prev_xr': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'}),
            'xr': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '20', 'decimal_places': '4'})
        },
