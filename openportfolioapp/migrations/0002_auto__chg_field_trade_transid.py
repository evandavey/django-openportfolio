...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trade.transid'
        db.alter_column('openportfolioapp_trade', 'transid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Trade.transid'
        db.alter_column('openportfolioapp_trade', 'transid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
