...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvestmentPrice.content_type2'
        db.add_column('openportfolioapp_investmentprice', 'content_type2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InvestmentPrice.content_type2'
        db.delete_column('openportfolioapp_investmentprice', 'content_type2_id')
