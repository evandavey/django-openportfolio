...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SavingsAccountPrice.dividend'
        db.delete_column('openportfolioapp_savingsaccountprice', 'dividend')

        # Deleting field 'ListedEquityPrice.dividend'
        db.delete_column('openportfolioapp_listedequityprice', 'dividend')

        # Adding field 'InvestmentPrice.dividend'
        db.add_column('openportfolioapp_investmentprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SavingsAccountPrice.dividend'
        db.add_column('openportfolioapp_savingsaccountprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=10), keep_default=False)

        # Adding field 'ListedEquityPrice.dividend'
        db.add_column('openportfolioapp_listedequityprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=10), keep_default=False)

        # Deleting field 'InvestmentPrice.dividend'
        db.delete_column('openportfolioapp_investmentprice', 'dividend')
    ...
    models = {
        ...
        'openportfolioapp.investmentprice': {
            ...
            'content_type2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True'}),
