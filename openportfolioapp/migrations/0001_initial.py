...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Return'
        db.create_table('openportfolioapp_return', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('prev_price', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('xr', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('prev_xr', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('dividend', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('freq', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
        ))
        db.send_create_signal('openportfolioapp', ['Return'])

        # Adding model 'PortfolioReturn'
        db.create_table('openportfolioapp_portfolioreturn', (
            ('return_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['openportfolioapp.Return'], unique=True, primary_key=True)),
            ('portfolio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openportfolioapp.Portfolio'])),
            ('bm_price', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('bm_prev_price', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
            ('bm_dividend', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=20, decimal_places=4)),
        ))
        db.send_create_signal('openportfolioapp', ['PortfolioReturn'])

        # Adding model 'InvestmentReturn'
        db.create_table('openportfolioapp_investmentreturn', (
            ('return_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['openportfolioapp.Return'], unique=True, primary_key=True)),
            ('investment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openportfolioapp.Investment'])),
        ))
        db.send_create_signal('openportfolioapp', ['InvestmentReturn'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('openportfolioapp_return')

        # Deleting model 'PortfolioReturn'
        db.delete_table('openportfolioapp_portfolioreturn')

        # Deleting model 'InvestmentReturn'
        db.delete_table('openportfolioapp_investmentreturn')
