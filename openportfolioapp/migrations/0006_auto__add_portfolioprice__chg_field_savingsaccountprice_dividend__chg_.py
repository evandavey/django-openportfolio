...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financemanager_portfolioprice', (
        ...
        db.send_create_signal('financemanager', ['PortfolioPrice'])

        # Changing field 'SavingsAccountPrice.dividend'
        db.alter_column('financemanager_savingsaccountprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'ListedEquityPrice.dividend'
        db.alter_column('financemanager_listedequityprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))


    def backwards(self, orm):
        
        # Deleting model 'PortfolioPrice'
        db.delete_table('financemanager_portfolioprice')

        # Changing field 'SavingsAccountPrice.dividend'
        db.alter_column('financemanager_savingsaccountprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))

        # Changing field 'ListedEquityPrice.dividend'
        db.alter_column('financemanager_listedequityprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))
