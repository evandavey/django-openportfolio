...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('openportfolioapp_savingsaccountprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'ListedEquityPrice.dividend'
        db.alter_column('openportfolioapp_listedequityprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SavingsAccountPrice.dividend'
        db.alter_column('openportfolioapp_savingsaccountprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))

        # Changing field 'ListedEquityPrice.dividend'
        db.alter_column('openportfolioapp_listedequityprice', 'dividend', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))
