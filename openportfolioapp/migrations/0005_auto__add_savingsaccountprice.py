...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financemanager_savingsaccountprice', (
        ...
        db.send_create_signal('financemanager', ['SavingsAccountPrice'])


    def backwards(self, orm):
        
        # Deleting model 'SavingsAccountPrice'
        db.delete_table('financemanager_savingsaccountprice')
