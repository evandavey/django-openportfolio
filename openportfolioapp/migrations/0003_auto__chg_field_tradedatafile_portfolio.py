...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('openportfolioapp_tradedatafile', 'portfolio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openportfolioapp.Portfolio'], null=True))


    def backwards(self, orm):
        
        # Changing field 'TradeDataFile.portfolio'
        db.alter_column('openportfolioapp_tradedatafile', 'portfolio_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['openportfolioapp.Portfolio']))
